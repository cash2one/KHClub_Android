 ...
 */
public abstract class EnhancedQuickAdapter<T> extends SHSContactAdapter<T> {
    ...
    @Override
    protected final void convert(SHSContactBaseAdapterHelper helper, T item) {
     ...
     */
    protected abstract void convert(SHSContactBaseAdapterHelper helper, T item, boolean itemChanged);
}
