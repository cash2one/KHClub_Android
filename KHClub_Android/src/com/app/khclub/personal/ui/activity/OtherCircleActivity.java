...
public class OtherCircleActivity extends BaseActivityWithTopBar {
	...
	private void initListViewSet() {
		// 设置内容
		circleAdapter = new HelloHaAdapter<CircleItemModel>(OtherCircleActivity.this, R.layout.activity_mycircle_item) {
			...
			protected void convert(HelloHaBaseAdapterHelper helper, final CircleItemModel item) {
				...
				linearLayout.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// 跳转到其他人页面
						Intent intent = new Intent(OtherCircleActivity.this, CirclePageActivity.class);
	...
	private void getData() {
		...
		HttpManager.get(path, new JsonRequestCallBack<String>(new LoadDataHandler<String>() {
			...
			public void onFailure(HttpException arg0, String arg1, String flag) {
				...
				hideLoading();
				Toast.makeText(OtherCircleActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
			}
