...
,Runnable{
	...
	protected void setUpView() {
		//标题
		setBarText(getResources().getString(R.string.news_where));
		...
		showLoading(getResources().getString(R.string.downloading), true);
		///////////定位////////////////
		/*
...
//			myLocation.setText(str);
	...
	public void run() {
		if (aMapLocation == null) {
			ToastUtil.show(this, getResources().getString(R.string.downloading_fail));
			stopLocation();// 销毁掉定位
		}
	}
...
//							.getSearchSuggestionCitys();// 当搜索不到poiitem数据时，会返回含有搜索关键字的城市信息
					if (poiItems != null && poiItems.size() > 0) {
						...
						ToastUtil.show(this, R.string.personal_none);
					}
				}
			} else {
				ToastUtil.show(this, R.string.personal_none);
