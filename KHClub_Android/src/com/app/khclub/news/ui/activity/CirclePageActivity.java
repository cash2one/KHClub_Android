...
//				pageView3.setVisibility(View.GONE);
	...
	protected void setUpView() {
		...
		//addRightImgBtn(R.id.layout_base_title,R.id.base_ll_right_btns, R.drawable.share_btn_normal);
...
//		refreshPush();
	...
	private void initBoradcastReceiver() {
		...
		mLocalBroadcastManager = LocalBroadcastManager
				.getInstance(CirclePageActivity.this);
...
//					}
	...
	private void jumpToNewsDetail(NewsItemModel itemModel, int keyBoardMode,
		...
		CirclePageActivity.this.overridePendingTransition(R.anim.push_right_in,
...
//		CirclePageActivity.this.registerReceiver(newMessageReceiver, intentFilter);
//	}
...
//	}
	...
	PlatformActionListener platformActionListener = new PlatformActionListener() {
		...
		public void onComplete(Platform arg0, int arg1,
			...
			// ToastUtil.show(CirclePageActivity.this, R.string.personal_share_ok);
		}
