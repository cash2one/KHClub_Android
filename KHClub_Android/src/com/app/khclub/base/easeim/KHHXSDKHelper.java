...
import com.app.khclub.base.easeim.applib.model.HXSDKModel;
 ...
 *
 */
public class KHHXSDKHelper extends HXSDKHelper{
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventNewMessage:
                    ...
                    if(activityList.size() <= 0){
                        KHHXSDKHelper.getInstance().getNotifier().onNewMsg(message);
                    }
                    break;
                case EventOfflineMessage:
                    if(activityList.size() <= 0){
                        ...
                        KHHXSDKHelper.getInstance().getNotifier().onNewMesg(messages);
                    }
                    break;
    ...
    protected HXNotificationInfoProvider getNotificationListener() {
        ...
        return new HXNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                Map<String,RobotUser> robotMap=((KHHXSDKHelper)KHHXSDKHelper.getInstance()).getRobotList();
...
//                }
    ...
    protected HXSDKModel createModel() {
        return new KHHXSDKModel(appContext);
    }
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((KHHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((KHHXSDKModel) hxModel).getDisabledIds();
                }
     ...
     */
    public KHHXSDKModel getModel(){
        return (KHHXSDKModel) hxModel;
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((KHHXSDKModel) getModel()).getContactList();
        }
	...
	public Map<String, RobotUser> getRobotList() {
		if (getHXId() != null && robotList == null) {
			robotList = ((KHHXSDKModel) getModel()).getRobotList();
		}
		return robotList;
	}
    ...
    public void saveContact(User user){
    	...
    	((KHHXSDKModel) getModel()).saveContact(user);
    }
    ...
    public void updateContactList(List<User> contactInfoList) {
        ...
        ((KHHXSDKModel)getModel()).saveContactList(mList);
    }
