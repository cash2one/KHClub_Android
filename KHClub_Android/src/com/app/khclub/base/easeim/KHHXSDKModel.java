...
import com.app.khclub.base.easeim.applib.model.DefaultHXSDKModel;
import com.app.khclub.base.easeim.db.HXDBManager;
...
public class KHHXSDKModel extends DefaultHXSDKModel{

    public KHHXSDKModel(Context ctx) {
        super(ctx);
    }
