...
import com.app.khclub.base.easeim.utils.DateUtils;
...
//			holder.avatar.setImageResource(R.drawable.group_icon);
			...
			//头像
			UserUtils.setGroupAvatar(getContext(), group, holder.avatar);
			//名字
...
//			digest = getStrng(context, R.string.picture) + imageBody.getFileName();
		...
		case VIDEO: // 视频消息
			...
			break;
		case TXT: // 文本消息
			if(((KHHXSDKHelper)HXSDKHelper.getInstance()).isRobotMenuMessage(message)){
				digest = ((KHHXSDKHelper)HXSDKHelper.getInstance()).getRobotMenuMessageDigest(message);
