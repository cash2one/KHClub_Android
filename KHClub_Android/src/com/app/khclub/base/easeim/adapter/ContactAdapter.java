...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
		    ...
		    holder.nameTextview.setText(user.getNick());
		    if (null == user.getNick() || user.getNick().length() < 1) {
		    	holder.nameTextview.setText(KHApplication.getInstance().getResources().getString(R.string.personal_none));
			}
		    //设置用户头像
