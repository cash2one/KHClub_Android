...
public class UserProfileActivity extends BaseActivity implements OnClickListener{
	...
	public void asyncFetchUserInfo(String username){
		((KHHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().asyncGetUserInfo(username, new EMValueCallBack<User>() {
	...
	private void updateRemoteNick(final String nickName) {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				boolean updatenick = ((KHHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().updateParseNickName(nickName);
	...
	private void uploadUserAvatar(final byte[] data) {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				final String avatarUrl = ((KHHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().uploadUserAvatar(data);
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						dialog.dismiss();
