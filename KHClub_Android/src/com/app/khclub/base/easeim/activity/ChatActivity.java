...
import com.app.khclub.base.easeim.adapter.ExpressionPagerAdapter;
import com.app.khclub.base.easeim.adapter.MessageAdapter;
import com.app.khclub.base.easeim.adapter.VoicePlayClickListener;
...
//		}
	...
	public void selectPicFromCamera() {
		...
		cameraFile = new File(PathUtil.getInstance().getImagePath(), KHUtils.selfCommonIMID()
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class.forName("com.app.khclub.base.easeim.utils.SmileUtils");
