 ...
 */
public abstract class EnhancedQuickAdapter<T> extends HelloHaAdapter<T> {
    ...
    @Override
    protected final void convert(HelloHaBaseAdapterHelper helper, T item) {
     ...
     */
    protected abstract void convert(HelloHaBaseAdapterHelper helper, T item, boolean itemChanged);
}
