 ...
 * </pre>
 */
public class HelloHaBaseAdapterHelper {
	...
	protected HelloHaBaseAdapterHelper(Context context, ViewGroup parent,
	...
	static HelloHaBaseAdapterHelper get(Context context, View convertView,
		...
		HelloHaBaseAdapterHelper existingHelper = (HelloHaBaseAdapterHelper) convertView
				.getTag();
	 ...
	 */
	public HelloHaBaseAdapterHelper setText(int viewId, String value) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setImageResource(int viewId, int imageResId) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setBackgroundColor(int viewId, int color) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setTextColor(int viewId, int textColor) {
		TextView view = retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setTextColorRes(int viewId, int textColorRes) {
		TextView view = retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setImageBuilder(int viewId) {
		ImageView view = retrieveView(viewId);
		// 代码未完善
		return this;
	}
	 ...
	 * times.
	 */
	public HelloHaBaseAdapterHelper setImageBitmap(int viewId, Bitmap bitmap) {
		ImageView view = retrieveView(viewId);
	 ...
	 */
	@SuppressLint("NewApi")
	public HelloHaBaseAdapterHelper setAlpha(int viewId, float value) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setVisible(int viewId, boolean visible) {
		View view = retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper linkify(int viewId) {
		TextView view = retrieveView(viewId);
	...
	public HelloHaBaseAdapterHelper setTypeface(int viewId, Typeface typeface) {
		TextView view = retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setMax(int viewId, int max) {
		ProgressBar view = retrieveView(viewId);
		view.setMax(max);
		return this;
	}
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setRating(int viewId, float rating) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setRating(int viewId, float rating, int max) {
		RatingBar view = retrieveView(viewId);
		view.setMax(max);
		view.setRating(rating);
		return this;
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setTag(int viewId, Object tag) {
		View view = retrieveView(viewId);
		view.setTag(tag);
		return this;
	}
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setTag(int viewId, int key, Object tag) {
		View view = retrieveView(viewId);
		view.setTag(key, tag);
		return this;
	}
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setChecked(int viewId, boolean checked) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setAdapter(int viewId, Adapter adapter) {
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setOnClickListener(int viewId,
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setOnTouchListener(int viewId,
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public HelloHaBaseAdapterHelper setOnLongClickListener(int viewId,
